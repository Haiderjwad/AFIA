        ...
        <div className="flex-1 p-8 bg-brand-cream overflow-y-auto no-scrollbar relative" dir="rtl">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-10 gap-6">
                <div className="flex items-center gap-4 text-right">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-brand-dark mb-1">حوكمة أداء الموظفين</h1>
                        <p className="text-brand-dark/40 font-bold text-sm">تتبع الإنتاجية والمسؤولية لكل حساب</p>
                    </div>
                </div>

                <div className="flex gap-3">
                    <button className="flex items-center gap-2 bg-white px-6 py-3 rounded-2xl font-bold text-brand-dark border border-brand-primary/10 shadow-sm hover:border-brand-primary transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-brand-primary/5 flex items-center gap-5">
                    <div className="bg-brand-primary/10 p-4 rounded-2xl text-brand-primary">
                        <ShoppingBag size={24} />
                    </div>
                    <div>
                        <p className="text-[10px] text-gray-400 font-black uppercase">إجمالي عمليات البيع</p>
                ...
                <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-brand-primary/5 flex items-center gap-5">
                    ...
                    <div>
                        <p className="text-[10px] text-gray-400 font-black uppercase">إجمالي تحضيرات المطبخ</p>
                ...
                <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-brand-primary/5 flex items-center gap-5">
                    ...
                    <div>
                        <p className="text-[10px] text-gray-400 font-black uppercase">إجمالي عمليات الاستلام</p>
                ...
                <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-brand-primary/5 flex items-center gap-5">
                    ...
                    <div>
                        <p className="text-[10px] text-gray-400 font-black uppercase">إجمالي فواتير الكاشير</p>
