      ...
      <div className="bg-white p-6 rounded-t-[2.5rem] shadow-[0_-5px_20px_rgba(0,0,0,0.05)] relative shrink-0">
        ...
        <div className="space-y-3">
            <button 
                ...
                className="w-full py-4 bg-gradient-to-r from-gold-500 to-gold-600 text-white rounded-xl font-bold text-lg shadow-xl shadow-gold-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
                <CreditCard size={20} />
                تأكيد والدفع
            </button>
