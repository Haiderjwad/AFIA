      ...
      <div className="bg-white w-full max-w-md p-8 rounded-[2.5rem] shadow-2xl border border-gold-100 z-10 animate-in fade-in zoom-in-95 duration-500 relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={!isOnline}
                required
                className="w-full pl-4 pr-12 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-gold-400 focus:border-transparent outline-none transition-all text-left text-coffee-900 font-bold placeholder-gray-400 disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <button
            ...
            className={`w-full font-bold py-4 rounded-xl shadow-lg transition-all transform active:scale-95 flex items-center justify-center gap-2 ${!isOnline ? 'bg-gray-200 text-gray-400 cursor-not-allowed' : 'bg-coffee-900 hover:bg-gold-600 text-white'}`}
          >
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-gray-400">جميع الحقوق محفوظة © Cafe Sun 2026</p>
        </div>
